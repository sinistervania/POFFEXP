...
(function() {
    Galv.CACHE.loadOnBoot = function() {
        // Add your image paths to be cached directly in the script
        Galv.CACHE.load('SumRndmDde/menu', 'EquipBGMirrored');
        Galv.CACHE.load('SumRndmDde/menu', 'ShopBGMirrored');
        Galv.CACHE.load('SumRndmDde/menu', 'WinterBG2');
    };

    Galv.CACHE.load = function(folder, img) {
        ImageManager.loadBitmap('img/' + folder + '/', img, 0, true);
    };

    Galv.CACHE.Scene_Boot_start = Scene_Boot.prototype.start;
    Scene_Boot.prototype.start = function() {
        Galv.CACHE.Scene_Boot_start.call(this);
        Galv.CACHE.loadOnBoot();
    };
