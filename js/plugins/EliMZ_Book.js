...
Eli.Utils = {
    ...
    getTextWidth(text, winClass = Window_Base){
        const tempWin = new winClass(new Rectangle(0, 0, 1000, 1000))

        return tempWin.textSizeEx(text.substring(0)).width
    },

    getTextSettings(text){
        const tempWin = new Window_Base(new Rectangle(0, 0, 1000, 1000))

        return tempWin.textSizeEx(text.substring(0))
    },
